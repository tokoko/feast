...
class MsSqlDataSourceCreator(DataSourceCreator):
    ...
    def create_offline_store_config(self) -> MsSqlServerOfflineStoreConfig:
        ...
        connection_string += "?driver=ODBCDriver18forSQLServer&TrustServerCertificate=Yes"
    ...
    def create_data_source(
        ...
        con.create_table(name=destination_name, schema=ibis.Schema.from_pandas(df.dtypes.to_dict().items()))
